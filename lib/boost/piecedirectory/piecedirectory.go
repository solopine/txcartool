...
import (
	...
	"errors"
	"fmt"
	carutil "github.com/solopine/txcartool/lib/boost/car"
	...
	bdtypes "github.com/solopine/txcartool/lib/boostd-data/svc/types"
	...
	"github.com/solopine/txcartool/lib/boost/piecedirectory/types"
)
...
func (ps *PieceDirectory) addIndexForPiece(ctx context.Context, pieceCid cid.Cid, dealInfo model.DealInfo) error {
	...
	//// Split the transfer into multiple concurrent parts to speed it up. Note that the index can't be generated by boostd-data itself
...
func TxParseRecordsFromCar(reader io.Reader) ([]model.Record, error) {
	return parseRecordsFromCar(reader)
}
